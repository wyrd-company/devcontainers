...
check "custom service user is configured" grep -q '^exec s6-setuidgid root ' /etc/s6-overlay/s6-rc.d/openbao-agent/run
check "custom service home is configured" grep -q ' HOME=/root ' /etc/s6-overlay/s6-rc.d/openbao-agent/run
